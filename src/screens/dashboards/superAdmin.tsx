...
export default function SuperAdminDashboard() {
  ...
  const { data: business, isLoading } = useGetBusinessByIdQuery(b._id);
  ...
  const {
    ...
    pickupId: selectedpickup, // You can replace this with the actual pickup ID or "current" for the current pickup
        ...
        ListHeaderComponent={
          <>
            <FilterChipsFDB
              ...
              onSelect={(id: any) => setSelectedpickup(id)}
              idExtractor={(item: any) => item._id}
              labelExtractor={(item: any) => item.pickup_name}
            />
